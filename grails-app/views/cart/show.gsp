            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="cart.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: cartInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${cartInstance?.user?.id}">${cartInstance?.user?.encodeAsHTML()}</g:link></td>
